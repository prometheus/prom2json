...
func main() {
	...
	skipCAcheck := flag.Bool("skipCAcheck", false, "Skip certificate check during tls handshake")
	flag.Parse()
	...
	go prom2json.FetchMetricFamilies(flag.Args()[0], mfChan, *cert, *key, *skipCAcheck)
